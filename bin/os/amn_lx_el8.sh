...
#                                                                      #
# This script purpose it to audit an Enterprise Linux 8 server.        #
#                                                                      #
# Version history:                                                     #
# +----------+------------+------+-----------------------------------+ #
...
FIL_INI_PKG="${DIR_TMP}/pkg_lx_el8.txt"
FIL_INI_CRON="${DIR_TMP}/crn_lx_el8.txt"
SCR_MK_INI="${DIR_TMP}/amn_mk_ini.sh"

# Default parameters
DEF_SYS_USR="root|bin|daemon|adm|lp|sync|shutdown|halt|mail|operator|games|ftp|nobody|dbus|systemd-coredump|systemd-resolve|tss|polkitd|unbound|sssd|sshd|rngd"
DEF_SYS_GRP="root|bin|daemon|sys|adm|tty|disk|lp|mem|kmem|wheel|cdrom|mail|man|dialout|floppy|games|tape|video|ftp|lock|audio|users|nobody|dbus|utmp|utempter|input|kvm|render|systemd-journal|systemd-coredump|systemd-resolve|tss|polkitd|unbound|ssh_keys|sssd|sshd|rngd"
DEF_IFS=${IFS}
DEF_CRON_DIR="0hourly"
DEF_CRON_H="0anacron"
DEF_CRON_D="logrotate|rhsmd"
DEF_CRON_W=""
DEF_CRON_M=""

# Exclusions.
EXC_FS_TYPE="-x tmpfs -x devtmpfs"
